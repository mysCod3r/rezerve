<x-admin-layout>
  ...
  <form method="POST" action="{{ route('admin.menus.store') }}" enctype="multipart/form-data">
    ...
    <div class="sm:col-span-6 pt-5">
      ...
      <div class="mt-1">
        <select id="categories" name="categories[]" class="from-multiselect block w-full mt-1" mutliple>
